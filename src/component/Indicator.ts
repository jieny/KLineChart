...
export type IndicatorCalcCallback<D, C, E> = (dataList: KLineData[], indicator: Indicator<D, C, E>, dataListForIndicator: KLineData[]) => Promise<Record<Timestamp, D>> | Record<Timestamp, D>
